...
use App\Models\Backend\Question_category;
...
{
    private $pathView = 'admin.pages.questioncategory';
    private $controllerName = 'questioncategory';
    private $nameInVN       = 'Loại câu hỏi';
    private $model;

    public function __construct()
    {
        $this->model = new Question_category();
        view()->share([
    ...
    public function index(Request $request,Question_category $Question_category)
    {
        // Auth()->user()->can('index');
        // dd(Auth()->user());
        $this->authorize('index', $Question_category);
    ...
    public function form(Request $request,Question_category $Question_category){
        $this->authorize('add', $Question_category);
        $items = [];
        // echo '<pre>';
        // print_r($permissions);
        // echo '<pre>';
        // die;
        if($request->id){
            $this->authorize('form', $Question_category);
    ...
    public function save(QuestionCategoryRequest $request){
        if($request->id){
            $fields = $request->all();
    ...
    public function changestatus(Request $request,Question_category $Question_category){
        $this->authorize('form', $Question_category);
    ...
    public function delete(Request $request,Question_category $Question_category){
